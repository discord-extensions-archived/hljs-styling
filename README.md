...
**BetterDiscord & Web support coming soon (hopefully the v1.0.0 release).**

# How does customization work?
In the `./styles` folder, you will see many different types of themes. These themes are based off of https://highlightjs.org/static/demo/, fit to work with Discord as best as they can. In order to use these styles, you must.. **{{PLACEHOLDER TEXT, COMING SOON WHENEVER I FINISH THIS DUMB SHI-}}**
- **NOTE:** Currently, there are no themes since I am currently reworking this, as I've stated above. For more information, read the **[v0.1.0d part of the changelog](https://github.com/Discord-Theme-Addons/hljs-styling/blob/main/CHANGELOG.md#v010d)**